...
const LoginSchema = Yup.object().shape({
    ...
    <div className='main-container'>
      ...
      {({errors})=>(<Form id="form" method='post'>
        ...
        <button onClick={handleSubmit} id="formSubmit"  className="btn-submit"  type='button'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-in-left" viewBox="0 0 16 16">
