    ...
    <div className='signup-container'>
        <div className='form-container'>
            ...
            {({errors})=>(  <Form id="form" method='post'>
                        ...
                        <button onClick={handleSubmit} id="formSubmit"className="submit-btn" type='button'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-vcard" viewBox="0 0 16 16">
